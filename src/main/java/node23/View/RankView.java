...
public class RankView extends JFrame implements ActionListener, WindowListener, KeyListener {
    ...
    public RankView(ArrayList<Game> games) throws BadLocationException {
        this.games = games;    
        ...
        jtp.setText(games.get(index).gameRaking()); 
